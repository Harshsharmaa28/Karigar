                ...
                <div className={'w-[100vw] h-[100vh] flex-col justify-center items-between bg-[url("/images/registerUser.jpg")] bg-cover md:bg-none '}>
                    ...
                    <div className={'w-[80%] sm:w-[60%] h-[90%] md:h-[95%] md:w-[75%] lg:h-[80%] lg:w-[60%] mx-auto mt-[3rem] flex-col md:flex md:flex-row items-center shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] border border-solid  rounded-2xl '}>
                        ...
                        <div className={' w-[100%] md:w-[50%] h-[100%] bg-white border md:border-0 border-solid rounded-2xl '}>
                            ...
                            <form className={'w-[100%] relative top-[8rem]'} onSubmit={handleSubmit}>
                                ...
                                <div className={'h-[15%] w-[75%] mx-auto my-2 md:m-7 flex border-b-2 border-solid  border-black  '}>
                                    ...
                                    <input type={'text'} className={'mx-2  w-[100%] p-2 pb-3 focus:outline-none  '} placeholder={'Username'} id={'naam'} name={'naam'} required autoComplete={'on'}></input>
                                </div>
                        ...
                        <div className="w-[50%] h-[100%]  ml-11 my-auto ">
                            ...
                            <div className="hidden md:block md:w-[100%] md:h-full md:bg-[url('/images/registerUser.jpg')] md:bg-cover md:bg-no-repeat md:bg-center md:py-10 md:px-10 md:border-r md:border-solid md:rounded-r-2xl">
