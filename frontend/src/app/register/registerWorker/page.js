                ...
                <div className={'w-[100vw] h-[100vh] flex justify-center items-center'}>
                    <div className={'w-[60%] h-[70%] flex  items-center shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] border border-solid  rounded-2xl '}>
                        ...
                        <div className={'w-[50%] h-[100%]'}>
                            <p className={'w-[100%] text-2xl mt-3 font-black text-center '}>Sign Up</p>

                            <form className={'w-[100%]'}>

                                <div className={'h-[1.7rem] w-[75%] m-7 flex border-b-2 border-solid border-black  '}>
                                    <label for={'naam'} className={' my-auto mx-2 pb-2'}><BiSolidUser /></label>
                                ...
                                <div className={'h-[1.7rem] m-7 w-[100%] my-2 flex  justify-between'} >
                                    ...
                                    <button className={"w-[25%] h-[1.9rem] mb-2 flex justify-center items-center text-md py-auto rounded px-3 mx-1 border-b-4 border-l-2 shadow-lg bg-blue-800 border-blue-900 text-white  hover:border-indigo-500 hover:bg-gradient-to-r from-sky-500 to-indigo-500"}>
                                        Verify
                                    </button>
                                </div>
                                ...
                                <div className={'h-[1.7rem] w-[75%] m-7 flex border-b-2 border-solid border-black  '}>
                                    ...
                                    <input type={'password'} className={'mx-2 p-2 pb-3 focus:outline-none  '} placeholder={'Confirm Password'} id={'c_password'} name={'c_password'}></input>
                                </div>
              ...
              <div>
                ...
                ></Image> */}
                        ...
                        <div className="w-[50%] h-[100%] ml-11 my-auto ">
                            <div class="hidden md:block w-[100%] h-full bg-indigo-500 py-10 px-10 border-r border-solid rounded-r-2xl">
