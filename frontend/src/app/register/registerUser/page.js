                        ...
                        <div className={'w-[50%] h-[100%]'}>
                            ...
                            <form className={'w-[100%] relative top-[3rem]'} onSubmit={handleSubmit}>
                                ...
                                <div className={'h-[1.7rem] w-[75%] m-7 flex border-b-2 border-solid border-black  '}>
                                    ...
                                    <input type={'text'} className={'mx-2 p-2 pb-3 focus:outline-none  '} placeholder={'Name'} id={'naam'} name={'naam'} required autoComplete={'on'}></input>
                                </div>
                                ...
                                <div className={'h-[1.7rem] m-7 w-[100%] my-2 flex  justify-between'} >
                                    <div className={'h-[1.7rem] w-[75%] flex border-b-2 border-solid border-black  '}>
                                        ...
                                        <input type={'number'} className={'mx-2 pb-2 focus:outline-none'} required placeholder={'Phone'} id={'phone'} name={'phone'} maxLength={10}></input>
                                    </div>

                                    <button className={"w-[25%] h-[1.9rem] mb-2 flex justify-center items-center text-md py-auto rounded px-3 mx-1 border-b-4 border-l-2 shadow-lg bg-blue-800 border-blue-900  hover:border-indigo-500 hover:bg-gradient-to-r from-sky-500 to-indigo-500 text-white"}>
                                        Verify
                                    </button>
                                </div>
                                ...
                                <div className={'h-[1.7rem] w-[75%] m-7 flex border-b-2 border-solid border-black  '}>
                                    ...
                                    <input type={'password'}  className={'mx-2 p-2 pb-3 focus:outline-none  '} autoComplete={'off'} placeholder={'Enter Password'} id={'password'} name={'password'} required ></input>
                                </div>

                                <div className={'h-[1.7rem] w-[75%] m-7 flex border-b-2 border-solid border-black  '}>
                                    <label htmlFor={'c_password'} className={' my-auto mx-2 pb-2'} ><RiLockPasswordFill /></label>
                                    <input type={'password'}  className={'mx-2 p-2 pb-3 focus:outline-none  '} autoComplete={'off'} placeholder={'Confirm Password'} id={'c_password'} name={'c_password'} required></input>
                                </div>

                                <div className={'h-auto m-7 w-[90%] mx-auto text-sl my-4 text-center text-semibold text-white '}>
                                    <input type={'submit'} className=" w-[80%] hover:cursor-pointer rounded px-3 py-2 m-1 border-b-4 border-l-2 shadow-lg bg-blue-800 border-blue-900 text-white hover:border-indigo-500 hover:bg-gradient-to-r from-sky-500 to-indigo-500" value={'Register'}></input>
